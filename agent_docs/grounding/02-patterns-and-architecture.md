...
**Doctrine hooks:** AX-01, AX-02, AX-03, AX-04, AX-05, AX-07, AX-08, AX-12, AX-15, AX-17, AX-18,
PAT-02, PAT-03, PAT-05, PAT-11, PAT-12, PAT-14, PAT-20, DD-04, DD-07, DD-16, DD-17, DF-01, DF-02,
DF-03, DF-04, DF-05
...
- **Thread Pool** — size for the workload (CPU vs I/O bound), bound the submission queue, and
  never block a pool task waiting on another task in the same pool — a deadlock class (PAT-20).
...
- **Context mapping** — name the relationship per integration: **shared kernel** couples release
  cadences (use sparingly), **customer–supplier** and **conformist** encode power, and the
  defaults at foreign seams are an **anti-corruption layer** translating the external model
  (PAT-02) or a versioned **published language** (AX-06).
